...
export const AREAS: AreaContent[] = [
  {
    ...
    city: "Valdosta",
    state: "GA",
    taglineEs: "El corazón del sur de Georgia.",
    taglineEn: "South Georgia's hub city.",
    blurbEs: "Centro del sur de Georgia. Barrios consolidados y fácil acceso.",
    blurbEn: "South Georgia's hub. Established neighborhoods and easy access.",
    bodyEs: [
      ...
      "Como agente bilingüe licenciada en Georgia y Florida, ayudo a familias a comprar y vender en Valdosta sin fricción, en español o en inglés. Conozco los precios por barrio, las escuelas y qué reparaciones valen la pena antes de listar.",
    ],
    bodyEn: [
      ...
      "As a bilingual agent licensed in Georgia and Florida, I help families buy and sell in Valdosta with no friction, in Spanish or English. I know block-by-block pricing, the schools, and which repairs actually pay off before you list.",
    ],
    keywordsEs: ["realtor Valdosta GA", "casas en venta Valdosta", "Valdosta homes for sale", "agente inmobiliario Valdosta"],
    keywordsEn: ["Valdosta realtor", "homes for sale Valdosta GA", "Valdosta GA real estate agent"],
  },
  {
    slug: "hahira",
    city: "Hahira",
  ...
  },
  {
    ...
    bodyEs: [
      "Si cruzas desde Georgia hacia el norte de Florida, trabajar con una agente licenciada en ambos estados ahorra meses. Cubro la transición de un lado a otro sin cambiar de profesional.",
      "Te ayudo con la compra o venta de tu propiedad en el norte de Florida, con el mismo trato bilingüe y cercano.",
    ],
    bodyEn: [
      "If you're crossing from Georgia into North Florida, working with an agent licensed in both states saves months. I cover the transition without swapping professionals.",
      "I'll help you buy or sell your North Florida property with the same bilingual, personal service.",
    ],
